...
object ChatApp {
  ...
  private final class Root extends Actor with ActorLogging with ActorSettings {
    ...
    private val userRepository = {
      val userRepository = context.actorOf(
        ClusterSingletonManager.props(
          UserRepository.props(settings.userRepository.userEvents),
          NotUsed,
  ...
  def main(args: Array[String]): Unit = {
    implicit val system = ActorSystem("gabbler-chat-system")
